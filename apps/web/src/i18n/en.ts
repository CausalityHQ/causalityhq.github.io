...
export const en: Content = {
  ...
  sieve: {
    ...
    demo: {
      ...
      narrateIdle:
        'Pick a sample query, then press Run, and SIEVE finds the closest documents by meaning.',
      steps: [
      ...
      figcaptionTpl:
        'How it works: SIEVE turns your query into a vector and finds the nearest documents by meaning. Here, ‘{q}’ matches ‘{n1}’ (cosine {s1}), ‘{n2}’ ({s2}) and ‘{n3}’ ({s3}). Everything runs locally, so no data leaves your browser.',
    },
  },
