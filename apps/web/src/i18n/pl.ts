...
export const pl: Content = {
  ...
  meta: {
    ...
    description:
      'Jesteśmy badaczami ML i inżynierami oprogramowania. Wdrażamy rozwiązania AI klasy State-of-the-Art w Twojej firmie. SIEVE — wyszukiwanie semantyczne on-premise; STRUCTURA — ustrukturyzowana ekstrakcja danych i agenci AI.',
  ...
  hero: {
    ...
    h1: 'Zasyp przepaść między swoim biznesem a nowoczesnym AI.',
    lead: 'Jesteśmy zespołem badaczy uczenia maszynowego i inżynierów. Wdrażamy AI klasy State-of-the-Art prosto w Twoje codzienne procesy — abyś mógł skalować biznes bez technologicznego długu.',
  ...
  trust: {
    label: 'POZYCJA',
    line: 'AI klasy badawczej, zaprojektowane do działania natywnie w infrastrukturze Twojej firmy.',
    chips: [
      'SIEDZIBA W UE',
  ...
  services: {
    tag: '§03 / USŁUGI',
    h2: 'Cztery sposoby, w jakie wdrażamy nowoczesne AI.',
    items: [
      {
        ref: 'SVC-01',
        title: 'Dedykowane Oprogramowanie AI',
        summary:
          'Rozwiązania State-of-the-Art zintegrowane bezpośrednio z Twoim produktem i procesami biznesowymi (workflow).',
        keys: ['dedykowane modele', 'integracja', 'production-grade'],
        primary: true,
      },
      {
        ref: 'SVC-02',
      ...
      },
      {
        ...
        summary:
          'Niezawodne i skalowalne systemy wokół modeli ML — zamiast jednorazowych prototypów w notebookach.',
      ...
      },
      {
        ...
        summary:
          'SIEVE i STRUCTURA — gotowe narzędzia AI klasy State-of-the-Art dla Twojego zespołu.',
  ...
  productsIntro: {
    ...
    frame:
      'SIEVE i STRUCTURA oddają najnowocześniejsze AI w ręce Twojego zespołu — wyszukiwanie, które rozumie kontekst, oraz agentów zmieniających surowe dane w konkretne akcje. Uruchom je w chmurze lub w pełni na infrastrukturze on-premise.',
  },
  ingest: {
    label: 'ŹRÓDŁA DANYCH',
    types: ['Dokumenty', 'Systemy i bazy danych', 'Obrazy', 'Nagrania'],
    email: 'Przekaż e-mail',
    note: 'Zasilaj system z dowolnego źródła — z plików, systemów biznesowych, zdjęć czy audio. Możesz po prostu przesłać e-mail na swoją skrzynkę Causality, a w kilka sekund będzie zindeksowany.',
  },
  sieve: {
    ref: 'PRD/SIEVE',
    name: 'SIEVE',
    h3: 'Wyszukiwanie semantyczne i głębokie rozumienie danych.',
    body: 'SIEVE przeszukuje i analizuje Twoje dane na podstawie kontekstu, a nie słów kluczowych, wykorzystując nasze autorskie przestrzenie wektorowe. Indeksuje tekst, dokumenty i pliki multimodalne w przestrzeni semantycznej, w której właściwa odpowiedź to po prostu nearest neighbour.',
    ...
    diagramSummary:
      'Zasada wdrożenia: SIEVE działa w 100% w Twojej infrastrukturze. Magazyn danych i indeks semantyczny są odizolowane wewnątrz środowiska klienta (perimeter). Zapytania są procesowane lokalnie na podstawie nearest neighbour. Gwarantujemy architekturę zero data egress — żadne dane nie opuszczają systemu.',
    perimeterLabel: 'ŚRODOWISKO KLIENTA (PERIMETER)',
    egressLabel: 'NO DATA EGRESS (ZERO WYCIEKÓW)',
    ...
    demo: {
      ...
      presets: [
        ...
        'zapewnij prywatność danych klientów',
        'przeszukuj obrazy i pliki audio',
      ],
      docs: [
        'baza wektorowa on-prem',
      ...
      liveResult:
        'Najlepsze dopasowanie: {n1}, cosine similarity {s1}. Znaleziono 3 nearest neighbours. Nie przesłano żadnych danych na zewnątrz.',
      figureTitle:
  ...
  structura: {
    ...
    body: 'STRUCTURA przekształca nieustrukturyzowane, multimodalne dane w solidny graf wiedzy (knowledge graph). Na jego podstawie uruchamia agentów AI, którzy wchodzą w interakcję z aplikacjami webowymi i automatyzują operacyjny workflow.',
    ...
    specs: [
      ...
      },
      {
        ...
        detail: 'Dedykowani agenci automatyzujący workflow bezpośrednio w przeglądarce',
        highlight: true,
      },
    ],
    ...
    demo: {
      ...
      intro:
        'Zautomatyzowany scenariusz: maile spływają asynchronicznie, agent aktualizuje graf wiedzy, monitoruje braki informacyjne, a po uzyskaniu kompletności – egzekwuje akcję w systemie webowym.',
      statusReady: 'GOTOWE · kliknij Play lub przechodź krok po kroku',
      stepReadout: 'KROK {n} / 5',
      captions: [
        'INGEST · dowolne źródło · plik · system · zdjęcie · e-mail',
      ...
      sr: [
        "Krok 1 z 5. Dane spływają do pipeline'u z dowolnych źródeł — systemów ERP, plików, zdjęć czy maili. Wszystko zostaje skonsolidowane w centralnym hubie.",
      ...
      figcaption:
        'Wizualizacja workflow: Źródła danych spływają asynchronicznie; STRUCTURA na bieżąco utrzymuje bazę wiedzy, podczas gdy agent AI konsoliduje spływające informacje i egzekwuje polecenia w aplikacjach webowych. Symulacja poglądowa.',
    },
  },
  about: {
    tag: '§07 / O NAS',
  ...
  eu: {
    ...
    intro:
      'Causality realizuje zaawansowane projekty badawczo-rozwojowe współfinansowane przez Unię Europejską. Poniżej przedstawiamy szczegóły naszych bieżących i zakończonych inicjatyw.',
    ...
    projects: [
      {
        title:
          'Opracowanie elastycznej i uniwersalnej metody generowania danych tekstowych i obrazowych o wysokiej jakości i wiarygodności na potrzeby budowy komercyjnych rozwiązań bazujących na uczeniu maszynowym',
        paragraphs: [
        ...
        tasksIntro: 'Rozwiązanie jest realizowane w ramach 4 głównych zadań badawczych:',
        tasks: [
  ...
  oss: {
    ...
    intro:
      'Wierzymy w otwarty kod. To kluczowe projekty, które wyrosły z naszych laboratoriów R&D — darmowe dla społeczności. Możesz z nich swobodnie korzystać, modyfikować je i integrować z własnym stosem technologicznym.',
    ...
    projects: [
      {
        ...
        description:
          'Zoptymalizowany silnik wyszukiwania podobieństwa napisany natywnie w Rust. Radykalnie obniża zużycie pamięci dzięki strumieniowemu odczytywaniu wektorów prosto z plików Parquet — zarówno z dysku lokalnego, jak i magazynów kompatybilnych z S3 (AWS S3, MinIO, SeaweedFS) — bez konieczności ładowania całych zbiorów danych do RAM. Projekt dostarcza natywne API dla Pythona (PyO3) oraz TypeScriptu (N-API) i obsługuje szeroki wachlarz metryk dla wektorów gęstych, histogramów, zbiorów oraz tekstu.',
